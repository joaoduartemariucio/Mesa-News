...
class LoginView: UIView, BaseView {
    ...
    var lblDecricaoTela: UILabel = {
        ...
        lbl.text = "tela_login_descricao".translate
    ...
    func setupTextFieldEmail(){
        ...
        NSLayoutConstraint.activate([
            txtEmail.topAnchor.constraint(equalTo: lblDecricaoTela.bottomAnchor, constant: size.height * 0.05),
    ...
    func setupButtonConfirmar(){
        ...
        NSLayoutConstraint.activate([
            btnConfirmar.topAnchor.constraint(equalTo: txtSenha.bottomAnchor, constant: size.height * 0.10),
    ...
    func setMensagensErro(erros: [ErrorModel<LoginErrorType>]){
        ...
        if let erroSenha = erros.first(where: { $0.typeError == .senhaVazia}){
